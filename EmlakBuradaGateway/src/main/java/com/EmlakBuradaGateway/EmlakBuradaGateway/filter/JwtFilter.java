package com.EmlakBuradaGateway.EmlakBuradaGateway.filter;

import java.security.Principal;
import java.util.List;

import com.EmlakBuradaGateway.EmlakBuradaGateway.util.JwtUtil;
...
//		}
        ...
        exchange.getRequest().mutate().header("enrolleeId", String.valueOf(claims.get("enrolleeId"))).build();
